...
exports.getStitchedSchemaFromSupergraphSdl = exports.getStitchingOptionsFromSupergraphSdl = exports.ensureSupergraphSDLAst = void 0;
...
function getStitchingOptionsFromSupergraphSdl(opts) {
    ...
    for (const [subgraphName, endpoint] of subgraphEndpointMap) {
        ...
        let executor = (0, executor_http_1.buildHTTPExecutor)({
            endpoint,
        ...
        if (candidates.some(candidate => rootTypeMap.has(candidate.type.name))) {
            ...
            return {
                ...
                resolve(_root, _args, context, info) {
                    ...
                    if (hasPromise) {
                        return Promise.all(jobs).then(results => (0, utils_1.mergeDeep)(results, false, true, true));
                    }
    ...
    for (const definition of supergraphAst.definitions) {
        if ('name' in definition && definition.name && definition.kind !== graphql_1.Kind.DIRECTIVE_DEFINITION) {
            ...
            if (!typeInSchema) {
                ...
                if (extraFields.length) {
                    let definitionKind;
                    if ((0, graphql_1.isObjectType)(typeInSchema)) {
                        definitionKind = graphql_1.Kind.OBJECT_TYPE_DEFINITION;
                    }
                    else if ((0, graphql_1.isInterfaceType)(typeInSchema)) {
                        definitionKind = graphql_1.Kind.INTERFACE_TYPE_DEFINITION;
                    }
                    else if ((0, graphql_1.isInputObjectType)(typeInSchema)) {
                        definitionKind = graphql_1.Kind.INPUT_OBJECT_TYPE_DEFINITION;
                    }
                    if (definitionKind) {
...
function getStitchedSchemaFromSupergraphSdl(opts) {
    ...
    const supergraphSchema = (0, stitch_1.stitchSchemas)(stitchSchemasOpts);
